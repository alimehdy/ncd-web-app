var getMonthlyReport = function()
{
	...
	$.ajax({
		...
		success:function(resp)
		{
			...
			$("#after_tr").before("<tr class='bg-info'><th></th><th>Monthly Report For:</th><th id='monthName' colspan='3'>"+displayValueOfMonth+"</th><th>TOTAL</th></tr>");
