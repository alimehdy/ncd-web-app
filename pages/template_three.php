...
<body>
        ...
        <li class="nav-item active">
          <div class="dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <a class="dropdown-item active" href="template_three.php">Template 6 - Chronic diseases patients</a>
      ...
      <div class="a col-xs-12 col-sm-12 col-md-12 col-lg-8 col-lg-push-12 col-md-push-12">
       <div class="row">
        <table  dir="rtl" lang="ar" class="table table-bordered table-responsive table-hover table-striped" id="tempThreeTable"> 
          ...
          <tr>
            <th colspan="9" style="text-align: center; font-family: 'times-new-roman'"><u>لائحة عن المرضى المزمنين</u></th>
          </tr>
          <tr>
          ...
          <tr id="after_tr">
            <th style="text-align: center; vertical-align: middle">رقم المريض</th>
            ...
            <th colspan="2" style="text-align: center; vertical-align: middle">اسم الدواء مع تحديد معياره</th>
            <th style="text-align: center; vertical-align: middle">الكمية المسلّمة بالحبة</th>
            <th style="text-align: center; vertical-align: middle">الامضاء</th>
          </tr>
        </table>
       </div>
      </div>
  ...
  <script src="../js/getTemplateSixData.js"></script>
