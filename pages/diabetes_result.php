<?php
  ...
  include_once('../php/getAssessmentInfo.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  <div class="row justify-content-md-center">
   <div class="a col-xs-12 col-sm-12 col-md-12 col-lg-8 col-lg-push-12 col-md-push-12">
     ...
     <table class="table table-hover table-responsive table-bordered" id="patient_table">
     <tr>
       <th style="text-align: center" colspan="4" class="bg-info">Diabetes Assessment Result</th>
     </tr>
       <tr>
         <th></th>
         <th><input type="date" class="form-control" name="date_of_assessment" id="date_of_assessment"><input type="hidden" class="form-control" name="pid" id="pid" value="<?php echo $_REQUEST['pid'] ?>"></th>
         <th><input type="number" class="form-control" name="assessment_result" id="assessment_result"></th>
         <th><input type="button" class="btn btn-primary" name="add_assessment" id="add_assessment" value="Add"></th>
       </tr>
       <tr class="myClass">
        <th colspan="4" style="text-align: center">Diabetes assessment result for patient <?php echo $res[0]['patient_name_en'] ?></th>
       </tr>
       <tr id="after_tr"  class="bg-info">
         <th>#</th>
         <th>Date Of Assessment</th>
         <th>Assessment Result</th>
         <th colspan="5" style="text-align:center">Actions</th>
       </tr>
       <?php $count=$execGetPatientInfo->rowCount(); foreach($res as $result) { if($result['date_of_assessment']!="") { ?>
       <tr id="<?php echo $result['diabetes_assessment_id'] ?>">
  ...
  <script src="../js/getDiabetesResults.js"></script>
