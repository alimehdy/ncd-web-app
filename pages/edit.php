   ...
   <div class="a col-xs-12 col-sm-12 col-md-12 col-lg-12 col-lg-push-12 col-md-push-12">
     ...
     <table class="table table-hover table-responsive" id="patient_table">
       ...
       <tr id="<?php echo $patient['patient_id']; ?>">
         <td><a href="patient_profile.php?pid=<?php echo $patient['patient_id']; ?>"><?php echo $patient['patient_id']; ?></a></td>
         ...
         <td><a href="edit_patient.php?pid=<?php echo $patient['patient_id']; ?>"><i class="badge badge-info" style="background-color: #0090ff">Edit Profile</i></a></td>
         <td><a href="patient_history.php?pid=<?php echo $patient['patient_id']; ?>"><i class="badge badge-info" style="background-color: #0090ff">Edit History</i></a></td>
       </tr>  
       <?php } ?>
     </table>
     </div>
