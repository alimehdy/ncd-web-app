...
<body>
        ...
        <li class="nav-item active">
          <div class="dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <a class="dropdown-item active" href="treatmentReport.php">Template 8 - Change treatment/Medication</a>
      ...
      <div class="a col-xs-12 col-sm-12 col-md-12 col-lg-8 col-lg-push-12 col-md-push-12">
       <div class="row">
        <table  dir="rtl" lang="ar" class="table table-bordered table-responsive table-hover table-striped" id="tempThreeTable"> 
          <tr>
            <th style="vertical-align: middle; text-align: center"><img id="img1" class="img-responsive" src="../images/ymca.png"></th>
            <th id="th3" style="vertical-align: middle; text-align: center">CODE: YMCA-F-02-07 (EDITION 1 Page 6/8)</th>
            <th colspan="3" style="vertical-align: middle; text-align: center" id="th2">
              GOOD STORAGE AND DISTRIBUTION. PRACTICES OF PHARMACEUTICAL
            </th>
            <th colspan="3" style="vertical-align: middle; text-align: center"><img id="img3" class="img-responsive" src="../images/unhcr.png"></th>
          </tr>
          <tr>
            <th colspan="9" style="text-align: center; font-family: 'times-new-roman'"><u>ملحق تغيير في العلاج للمرضى المزمنين</u></th>
          </tr>
          <tr>
            <th style="text-align: right">نموذج رقم</th>
            <th style="text-align: right" colspan="4" id="tempNum">٦</th>
          ...
          <tr>
            ...
            <th style="text-align: right; vertical-align: middle" colspan="8">مستوصف بريتال الخيري</th>
          </tr>
          <tr id="after_tr">
            <th colspan="2" style="text-align: center; vertical-align: middle">الاسم الثلاثي</th>
            <th colspan="3" style="text-align: center; vertical-align: middle">العلاج القديم مع تحديد الكميّة</th>
            <th colspan="4" style="text-align: center; vertical-align: middle">العلاج الجديد مع تحديد الكميّة</th>
          </tr>
        </table>
       </div>
      </div>
  ...
  <script src="../js/getTemplateEightData.js"></script>
