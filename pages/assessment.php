<?php
  ...
  include_once('../php/getAssessmentResultByMonth.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
  <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <a class="dropdown-item active" href="appointment.php">Next Appointment</a>
      ...
      <form class="form-inline my-2 my-lg-0">
        <input class="form-control mr-sm-2 searchElement" type="text" id="searchDate" name="searchDate" placeholder="Search...">
  ...
  <div class="row justify-content-lg-center">
   <div class="col-sm-4">
   <div id="get_app" name="get_app" class="a col-xs-12 col-sm-8 col-md-8 col-lg-8 col-lg-push-8 col-md-push-6">
   <table class='table table-bordered table-hover table-responsive table-striped' id="after_table">
     ...
     <tr>
       <td><?php echo $res['assessmentDate'] ?></td>
       <td><?php echo $res['avgAssessment'] ?></td>
     </tr>
     <?php } ?>
   </table>
   </div>
   ...
   <div class="card">
    <div class="card card-header">
      Diabetes Assessment Averages Over Months
    </div>
  ...
  <script src="../js/getAssessmentResultsByMonth.js"></script>
  <!--<script src="../js/getAssessmentResultsByMonth.js"></script>-->
