...
<body>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <div class="dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              <a class="dropdown-item active" href="chronic_list.php">Template 3 - Chronic diseases patients</a>
       ...
       <div class="row">
        <table  dir="rtl" lang="ar" class="table table-bordered table-responsive table-hover table-striped" id="tempThreeTable"> 
          ...
          <tr>
            ...
            <th style="text-align: right" colspan="4" id="tempNum">۳</th>
  ...
  <script src="../js/getTemplateThreeData.js"></script>
