<?php
  ...
  include_once('../php/getExpiredMed.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
        ...
        <li class="nav-item">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <a class="dropdown-item active" href="expiredMed.php">Nearly Expired Med</a>
            </div>
          </div>
        </li>
        <li class="nav-item">
  ...
  <div class="col-sm-12">
   ...
   <div class="a col-xs-12 col-sm-12 col-md-12 col-lg-12 col-lg-push-12 col-md-push-12">
     ...
     <tr><th colspan="12" class="bg-info" style="text-align: center;">Medication that will expire in nearly 3 months</th></tr>
       <?php if($count>0){ ?>
       <tr class="bg-info">
         <th>#</th>
         <th>Med ID</th>
       ...
       <?php } ?>
      <?php $i=1; foreach($execGetExpiredMed as $result) { if($result['still_pills']>0){ ?>
      <tr>
        <td><?php echo $i++ ?></td>
        <td><?php echo $result['med_id'] ?></td>
        <td><?php echo $result['med_name']; ?></td>
        <td><?php echo $result['med_expiry']; ?></td>
        <td><?php echo $result['med_barcode']; ?></td>
        <td><?php echo $result['med_tablet']; ?></td>
        <td><?php echo $result['med_pill']; ?></td>
        <td><?php echo $result['med_received']; ?></td>
        <td><?php echo $result['given_pills']; ?></td>
        <td><?php echo $result['still_tablets']; ?></td>
        <td><?php echo $result['still_pills']; ?></td>
        <td><?php echo $result['still_to_expire']; ?></td>
      </tr>
      <?php } } ?>
     </table>
     </div>
