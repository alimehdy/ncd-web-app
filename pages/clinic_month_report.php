...
<body>
        ...
        <li class="nav-item active">
          <div class="dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <a class="dropdown-item active" href="clinic_month_report.php">Template 5 - Clinic Monthly Report</a>
      ...
      <div class="a col-xs-12 col-sm-12 col-md-12 col-lg-8 col-lg-push-12 col-md-push-12">
       <div class="row">
        <table  dir="rtl" lang="ar" class="table table-bordered table-responsive table-hover table-striped" id="tempThreeTable"> 
          ...
          <tr>
            <th colspan="9" style="text-align: center; font-family: 'times-new-roman'"><u>التقرير الشهري للمستوصف</u></th>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <th style="text-align: right" colspan="8" id="tempNum">٥</th>
          </tr>
          <tr>
            <th colspan="8" style="text-align: right">١. الفترة الزمنية التي يغطيها التقرير:</th>
          </tr>
          <tr>
            <th style="text-align: right">الشهر:</th>
            <th style="text-align: right" colspan="8" id="getMonthName"></th>
          </tr>
          <tr>
            <th style="text-align: right">السنة:</th>
            <th style="text-align: right" colspan="8" id="getYearName"></th>
          </tr>
          <tr>
            <th style="text-align: right" colspan="8">
              ٢. العدد الكامل للمرضى المستفيدين من البرنامج:
            </th>
          </tr>
          <tr id="after_tr">
            <tr>
              <th style="text-align: right">عدد المرضى المزمنين المستفيدين:</th>
              <th style="text-align: right" colspan="8" id="chronic"></th>
            </tr>
            <tr>
              <th style="text-align: right">عدد المرضى غير المزمنين المستفيدين:</th>
              <th style="text-align: right" colspan="8" id="nonChronic"></th>
            </tr>
          </tr>
          <tr>
            <th colspan="8" style="text-align: right">
            التقرير الشهري يتضمن<br>
            لائحة بأسماء المرضى المزمنين الذين استفادوا من جمعية الشبان المسيحية، اسم الدواء و التوقيع للنموذج المرفق (٦).<br>
            لائحة باسماء المرضى الغير مزمنين الذين استفادوا من الأدوية المقدمة من جمعية الشبان المسيحية، مع اسم الدواء و الكمية "بدون توقيع" وفقا للنموذج المرفق رقم (۷).
            <br>
            <br>
          ...
          <tr>
            <th colspan="4"></th>
            <th style="text-align: left">الامضاء:</th>
            <th colspan="3"></th>
          </tr>
          <tr>
            <th colspan="4"></th>
  ...
  <script src="../js/getTemplateFiveData.js"></script>
