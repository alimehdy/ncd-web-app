...
<body>
  <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline my-2 my-lg-0">
        <input class="form-control mr-sm-2 searchElement" type="date" id="searchDate" name="searchDate" placeholder="Search...">
  ...
  <div class="row justify-content-md-center">
   ...
   <table class='table table-bordered table-hover table-responsive' id="after_table">
     <tr class="bg-info">
       <th>Patient ID</th>
       <th>Patient Name</th>
  ...
  <script src="../js/getAppointments.js"></script>
