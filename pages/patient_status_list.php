...
<body>
        ...
        <li class="nav-item active">
          <div class="dropdown active">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <a class="dropdown-item active" href="patient_status_list.php">Template 9 - Patients Discharged/Diceased</a>
  ...
  <div class="container" id="print_div">
    <div class="row justify-content-md-center">
      <div class="a col-xs-12 col-sm-12 col-md-12 col-lg-12 col-lg-push-8 col-md-push-12">
       <div class="row">
        <table  dir="rtl" lang="ar" class="table table-bordered table-responsive table-hover table-striped" id="tempThreeTable" style="width: 900px"> 
          <tr>
          ...
          <tr>
            <th colspan="9" style="text-align: center; font-family: 'times-new-roman'"><u>لائحة عن المرضى المتوفين أو المنتقلين الى عيادة أخرى</u></th>
          </tr>
          <tr>
            <th style="text-align: right">نموذج رقم</th>
            <th style="text-align: right" colspan="4" id="tempNum">۹</th>
          ...
          <tr>
            <th colspan="9" style="text-align: right;">1) عدد المرضى المتوفين</th>
          <tr>
          <tr id="after_tr_deceased">
            <th colspan="3" style="text-align: center; vertical-align: middle">الاسم الثلاثي</th>
            <th colspan="3" style="text-align: center; vertical-align: middle" id="thCode">رقم بطاقة اللجوء</th>
            <th colspan="3" style="text-align: center; vertical-align: middle">الجنسية</th>
          </tr>
          <tr>
            <th colspan="9" style="text-align: right;">2) عدد الأشخاص الذين توقفوا عن العلاج</th>
          </tr>
          <tr id="after_tr_discharged">
            <th colspan="3" style="text-align: center; vertical-align: middle">الاسم الثلاثي</th>
            <th colspan="3" style="text-align: center; vertical-align: middle" id="thCode2">رقم بطاقة اللجوء</th>
            <th colspan="3" style="text-align: center; vertical-align: middle">الجنسية</th>
          </tr>
        </table>
       </div>
  ...
  <script src="../js/getTemplateNineData.js"></script>
