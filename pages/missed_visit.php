<?php
  ...
  include_once('../php/getMissedVisits.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
        ...
        <li class="nav-item">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
              ...
              <a class="dropdown-item active" href="missed_visit.php">Missed Visit</a>
            </div>
          </div>
        </li>
        <li class="nav-item">
  ...
  <div class="col-sm-12">
   ...
   <div class="a col-xs-12 col-sm-12 col-md-12 col-lg-12 col-lg-push-12 col-md-push-12">
     ...
     <?php if($count>0) { ?>
     <tr><th colspan="9" class="bg-info" style="text-align: center;">Patients who missed their visit</th></tr>
       <tr class="bg-info">
         <th>#</th>
         <th>Patient ID</th>
         <th>Patient Name</th>
      ...
      <?php } else { ?>
        <tr>
          <th colspan="9">There is no missed visit by any of the patients registered in our program</th>
        </tr>
      <?php } ?>
      ...
      <tr>
        ...
        <td><?php echo $result['patient_name_en']; ?></td>
        <td><?php echo $result['patient_phone']; ?></td>
        <td><?php echo $result['patient_status']; ?></td>
        <td><?php echo $result['patient_alt_name']; ?></td>
        <td><?php echo $result['patient_alt_contact_add']; ?></td>
        <td><?php echo $result['date_of_visit']; ?></td>
        <?php if($result['days_missed']>90){ ?>
        <td bgcolor="#FF0000"><?php echo $result['days_missed']; ?></td>
        <?php } else { ?>
        <td><?php echo $result['days_missed']; ?></td>
        <?php } ?>
      </tr>
      <?php } ?>
     </table>
